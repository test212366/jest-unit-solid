...
exports.buttons = exports.customAppendChild = void 0;

function create(tag, classItem = '', text = '') {
...
},{}],"blocks/createhtml.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createCalc = void 0;
...
const createCalc = () => {
  ...
  let title, body;
  const calc = (0, _utils.create)('div', 'calculator');
  (0, _utils.customAppendChild)([title = (0, _utils.create)('div', 'title'), body = (0, _utils.create)('div', 'body')], calc);
  (0, _utils.customAppendChild)([(0, _utils.create)('input', 'input')], title);
  body.insertAdjacentHTML('afterbegin', (0, _utils.buttons)());
  $container.appendChild(calc);
};

exports.createCalc = createCalc;
},{"./utils":"blocks/utils.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _createhtml = require("./blocks/createhtml");

document.addEventListener('DOMContentLoaded', () => {
  (0, _createhtml.createCalc)();
...
},{"./blocks/createhtml":"blocks/createhtml.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5141" + '/');
